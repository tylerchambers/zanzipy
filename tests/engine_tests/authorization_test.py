...
class TestAuthorizationEngineConfiguration:
    def test_authorization_engine_shares_depth_and_debug_across_operations(
        self,
    ) -> None:
        registry = _registry()
    ...
    def test_authorization_engine_owns_tuple_cache_decorator(self) -> None:
        registry = _registry()
        repo = _repo_with_owner()
    ...
    def test_authorization_engine_shares_compiled_model_across_operations(self) -> None:
        registry = _registry()
        repo = _repo_with_owner()
    ...
    def test_authorization_engine_rebuild_refreshes_lookup_metadata(self) -> None:
        registry = SchemaRegistry()
