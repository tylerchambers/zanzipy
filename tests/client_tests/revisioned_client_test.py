...
class TestRevisionedZanzibarClient:
    def test_write_result_drives_at_least_as_fresh_check_and_reads(self) -> None:
    ...
    def test_explicit_revision_reads_remain_stable_after_delete(self) -> None:
        client = ZanzibarClient(
            relations_repository=InMemoryRelationRepository(),
            schema=_registry(),
        )
